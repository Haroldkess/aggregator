...
//============================== Navigation ================================\\
  ...
  void _callCustomer() {
    ...
    UrlLaunchController.makePhoneCall(widget.order.client!.phone!);
  }
                              ...
                              children: [
                                  ...
                                  child: Text.rich(
                                    ...
                                    TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: widget.order.orderitems!.isEmpty
                                              ? ""
                                ...
                                Text.rich(
                                  TextSpan(
                                    children: [
                                      TextSpan(
                                        text:"₦ ${convertToCurrency(widget.order.totalPrice.toString())}",
                                        style: const TextStyle(
                                          color: Color(0xFF222222),
                                          fontSize: 14,
                                          fontFamily: 'Sen',
                                ...
                                Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: convertToCurrency(
                                            "${(num.tryParse(widget.order.totalPrice.toString())! + num.tryParse(widget.order.deliveryFee.toString())!)}"),
                                        style: const TextStyle(
                                          color: Color(0xFF222222),
                                          fontSize: 14.30,
                                          fontWeight: FontWeight.w700,
