...
//Vendor
  ...
  static const addProductToVendor = "/api/v1/agents/agentAddProductToVendor";
    static const getVendorListRatings = "/api/v1/agents/getVendorRatings/";
  ...
  //Banks
  static const bankList = "/api/v1/payments/list_banks/";
  static const validateBank = "/api/v1/payments/validateBankNumbers/";
  static const addBank = "/api/v1/payments/saveBankDetails";
  static const savedBank = "/api/v1/payments/getAllSaveBankDetails";
  static const agentWithdrawal = "/api/v1/wallet/agentWithdrawal";
}
